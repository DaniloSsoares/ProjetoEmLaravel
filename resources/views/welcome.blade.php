          ...
          <div class="containercard">
            ...
            <div class="card">
              <figure class="card__thumb">
                <img src="/img/open.jpg" alt="Picture by Štefan Štefančík" class="card__image">
            ...
            @if (count($filmes) > 0)
                @foreach ($filmes as $fil)
                  <article class="flex items-start space-x-6 p-6">
                    ...
                    @if($fil->capa)
                      <img src="{{asset('storage/'. $fil->capa)}}" width="60" height="88" class="flex-none rounded-md bg-slate-100" />
                    @endif
